      ...
      <div className="mx-auto max-w-7xl">
        ...
        >
          ...
          <div className="inline-flex items-center gap-4 mb-6">
            ...
            <p className="text-xs md:text-sm font-bold tracking-[0.3em] text-gold uppercase">
              {t.library.badge}
            </p>
            <span className="w-12 h-[1px] bg-gold/50" />
          </div>
            ...
            return (
              ...
              >
                ...
                <div className="relative w-full aspect-[2/3] rounded-l-sm rounded-r-xl overflow-hidden shadow-[4px_4px_10px_rgba(0,0,0,0.15),_inset_-4px_0_4px_rgba(255,255,255,0.4)] group-hover:-translate-y-3 group-hover:-rotate-1 group-hover:shadow-[15px_20px_30px_rgba(0,0,0,0.2)] transition-all duration-500 bg-muted">
                  ...
                  {i === 0 && (
                    <div className="absolute top-4 right-0 z-20 translate-x-1">
                      <div className="bg-gradient-to-r from-gold to-gold-dim text-foreground text-[9px] font-bold uppercase tracking-wider px-3 py-1.5 rounded-l-sm shadow-[0_4px_10px_rgba(213,173,54,0.4)]">
                        Yangi nashr
                      </div>
                      <div className="absolute -bottom-1 right-0 border-t-4 border-l-4 border-t-gold-dim border-l-transparent w-1 h-1" />
                    </div>
                  )}
                ...
                <div className="flex flex-col items-center text-center mt-3 px-2">
                  <h3 className="font-heading text-lg font-bold leading-tight tracking-wide text-foreground text-center line-clamp-2 transition-colors duration-500 ease-out">
                    {locField(book, "title", lang)}
                  </h3>
                  <span className="w-8 h-[1.5px] bg-gold/40 my-2 transition-all duration-500 group-hover:w-16 group-hover:bg-gold" />
                  <p className="font-sans text-[9px] font-bold uppercase tracking-[0.2em] text-gold mt-1">

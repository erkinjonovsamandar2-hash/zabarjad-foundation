...
class ErrorBoundary extends Component<Props, State> {
  ...
  public componentDidCatch(error: Error, errorInfo: ErrorInfo) {
    ...
    console.error("Booktopia App Error:", error, errorInfo);
  }
      ...
      return (
        <div className="min-h-screen flex items-center justify-center bg-background p-6 relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-lg w-full text-center flex flex-col items-center">
            ...
            <h1 className="font-heading font-black tracking-tight text-3xl sm:text-4xl text-foreground mb-4 drop-shadow-sm">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 w-full justify-center">
              <button
                ...
                className="w-full sm:w-auto flex items-center justify-center gap-2 bg-primary hover:bg-primary/90 text-white px-8 py-3.5 rounded-xl font-bold font-sans text-sm transition-all shadow-md hover:shadow-lg focus:outline-none"
              >
            ...
            <div className="mt-16 flex flex-col items-center opacity-50">
              <span className="font-sans text-[11px] uppercase tracking-[0.4em] font-bold">Booktopia</span>
            </div>
